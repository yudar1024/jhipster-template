...
import com.mycompany.myapp.config.common.CommonConstants;
...
@EnableMongoRepositories("com.mycompany.myapp.repository.nosql")
@Profile(CommonConstants.NOSQL_PROFILE)
